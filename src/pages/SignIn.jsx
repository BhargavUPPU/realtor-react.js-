...
export default function SignIn() {
  ...
  <div className='w-full md:w-[67%] lg:w-[40%] ml-20'>
    <forms>
      <input type='text' className=' mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out'  id="email" value={email} onChange={onChange} placeholder='Email address' ></input>
